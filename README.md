...
~~Open frostfallKeep.dme by double-clicking it, open the Build menu, and click
...
```
saving frostfallKeep.dmb (DEBUG mode)
frostfallKeep.dmb - 0 errors, 0 warnings
```
...
compiled frostfallKeep.dmb file. Make sure to set the port to the one you
