...
// MEDICAL SUITS (renamed Special Garb)
...
// BALLISTIC ARMOR (renamed Scrappy Armor)
...
/datum/gear/suit/dress
	name = "female blue surcotte"
	path = /obj/item/clothing/suit/armor/outfit/dress/bluerobe
	subcategory = LOADOUT_SUBCATEGORY_SUIT_JACKETS
	cost = 1

/datum/gear/suit/dress/redrobe
	name = "female red surcotte"
	path = /obj/item/clothing/suit/armor/outfit/dress/redrobe
	subcategory = LOADOUT_SUBCATEGORY_SUIT_JACKETS
	cost = 1

/datum/gear/suit/dress/purplerobe
	name = "female purple surcotte"
	path = /obj/item/clothing/suit/armor/outfit/dress/purplerobe
	subcategory = LOADOUT_SUBCATEGORY_SUIT_JACKETS
	cost = 1

/datum/gear/suit/dress/red
	name = "female red vestment"
	path = /obj/item/clothing/suit/armor/outfit/dress
	subcategory = LOADOUT_SUBCATEGORY_SUIT_JACKETS
	cost = 2

/datum/gear/suit/dress/rose
	name = "female rose vestment"
	path = /obj/item/clothing/suit/armor/outfit/dress/rose
	subcategory = LOADOUT_SUBCATEGORY_SUIT_JACKETS
	cost = 2

/datum/gear/suit/dress/white
	name = "female white vestment"
	path = /obj/item/clothing/suit/armor/outfit/dress/white
	subcategory = LOADOUT_SUBCATEGORY_SUIT_JACKETS
	cost = 2

/datum/gear/suit/femalearmorblue
	name = "feminine cuirass w/ blue surcoat"
	path = /obj/item/clothing/suit/armor/outfit/armordress
	subcategory = LOADOUT_SUBCATEGORY_SUIT_JACKETS
	cost = 2

/datum/gear/suit/femalearmorred
	name = "feminine cuirass w/ red surcoat"
	path = /obj/item/clothing/suit/armor/outfit/armordress/red
	subcategory = LOADOUT_SUBCATEGORY_SUIT_JACKETS
	cost = 2
